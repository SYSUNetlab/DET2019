...
if __name__ == "__main__":
    # 读取多次实验性的能平均值
    mat_files = ['./result/freescale256_performance_struct_SI_newcut_py_newV2newEst.mat']
    performance_GNB2A = []
    ...
    eps_name = [eps_prefix + 'scalefree256_performance_SI.eps']
    figure_title = ['scalefree256 SI']
