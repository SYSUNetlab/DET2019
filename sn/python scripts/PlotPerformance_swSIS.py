...
if __name__ == "__main__":
    # 读取多次实验性的能平均值
    mat_files = ['./result/smallworld256_performance_struct_SIS_newcut_py_newV2.mat']
    performance_GNB2A = []
    ...
    eps_name = [eps_prefix + 'smallworld256_performance_SIS.eps']
    figure_title = ['smallworld256 SIS']
    ...
    left_ax.set_ylim(50, 100)
    right_ax.set_xlim(0, 12)
    right_ax.set_ylim(50, 100)
