...
if __name__ == "__main__":
    ...
    mat_files = ['./data/freescale256_sourcedata_SISV2.mat']
    sourcedata_names = ['freescale256_observedata_SIS']
    label_names = ['freescale256_label_SIS_block']
    ...
    for file_list_id in range(len(mat_files)):
        ...
        freescale256_SIS_performance = {'performance_average_train_KMeans': performance_average_train_KMeans,
    ...
    with open('./result/performance_freescale256_SISV2.pickle', 'wb') as f:
        pickle.dump([freescale256_SIS_performance], f)

    with open('./result/performance_freescale256_SISV2.pickle', 'rb') as f:
        freescale256_SIS_performance = pickle.load(f)
    time2 = time.time()
