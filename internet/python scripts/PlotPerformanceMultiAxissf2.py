...
if __name__ == "__main__":
    # 读取多次实验性的能平均值
    # mat_files = ['./result/scalefree64_performance_struct_ddos2_pyR1.mat']
    ...
    with open('./result/performance_scalefree64_ddos2_R1.pickle', 'rb') as f:
    ...
    eps_name = [eps_prefix + 'scalefree64_performance_ddos2.eps']
