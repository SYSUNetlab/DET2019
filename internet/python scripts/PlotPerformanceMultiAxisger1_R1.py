...
if __name__ == "__main__":
    # 读取多次实验性的能平均值
    mat_files = ['./data4py_R/germany50_performance_struct_ddos1_pyR1.mat']
    performance_STCA = []
    ...
    with open('./data4py_R/performance_germany50_ddos1_R1.pickle', 'rb') as f:
    ...
    eps_name = [eps_prefix + 'germany50_performance_ddos1_R1.eps']
    figure_title = ['germany50 ddos1']
    ...
    left_ax.set_ylim(70, 95)
    right_ax.set_xlim(0, 12)
    right_ax.set_ylim(30, 90)
