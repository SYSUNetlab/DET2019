...
if __name__ == "__main__":
    # 读取多次实验性的能平均值
    mat_files = ['./data4py_R/scalefree64_performance_struct_ddos1_pyR1.mat']
    performance_STCA = []
    ...
    with open('./data4py_R/performance_scalefree64_ddos1_R1.pickle', 'rb') as f:
    ...
    eps_name = [eps_prefix + 'scalefree64_performance_ddos1_R1.eps']
