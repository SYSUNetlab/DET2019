...
if __name__ == "__main__":
    ...
    #mat_files = ['./data/scalefree64_sourcedata_ddos2_V1_add.mat']
    mat_files = ['./data/scalefree64_sourcedata_ddos2_R1.mat']
    sourcedata_names1 = ['scalefree64_dst_entropy_ddos2', 'colt_dst_entropy_ddos2', 'smallworld128_dst_entropy_ddos1', 'smallworld128_dst_entropy_ddos2']
    sourcedata_names2 = ['scalefree64_arrival_rate_ddos2', 'colt_arrival_rate_ddos2', 'smallworld128_arrival_rate_ddos1', 'smallworld128_arrival_rate_ddos2']
    label_names = ['scalefree64_data_label_ddos2_block', 'colt_data_label_ddos2_block', 'smallworld128_data_label_ddos1_block', 'smallworld128_data_label_ddos2_block']
    ...
    for file_list_id in range(len(mat_files)):
        ...
        scalefree64_ddos2_performance = {'performance_average_train_KMeans': performance_average_train_KMeans,
    ...
    # save variables
    with open('./result/performance_scalefree64_ddos2_R1.pickle', 'wb') as f:
        pickle.dump([scalefree64_ddos2_performance], f)

    # with open('./result/performance_scalefree64_ddos2.pickle', 'rb') as f:
