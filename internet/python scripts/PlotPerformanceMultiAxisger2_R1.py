...
if __name__ == "__main__":
    # 读取多次实验性的能平均值
    mat_files = ['./data4py_R/germany50_performance_struct_ddos2_pyR1.mat']
    performance_STCA = []
    ...
    with open('./data4py_R/performance_germany50_ddos2_R1.pickle', 'rb') as f:
    ...
    eps_name = [eps_prefix + 'germany50_performance_ddos2_R1.eps']
    figure_title = ['germany50 ddos2']
