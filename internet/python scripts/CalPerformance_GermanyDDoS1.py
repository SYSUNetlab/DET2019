...
if __name__ == "__main__":
    ...
    mat_files = ['./data/germany50_sourcedata_ddos1.mat']
    sourcedata_names1 = ['germany50_dst_entropy_ddos1', 'colt_dst_entropy_ddos2', 'smallworld128_dst_entropy_ddos1', 'smallworld128_dst_entropy_ddos2']
    sourcedata_names2 = ['germany50_arrival_rate_ddos1', 'colt_arrival_rate_ddos2', 'smallworld128_arrival_rate_ddos1', 'smallworld128_arrival_rate_ddos2']
    label_names = ['germany50_data_label_ddos1_block', 'colt_data_label_ddos2_block', 'smallworld128_data_label_ddos1_block', 'smallworld128_data_label_ddos2_block']
    ...
    for file_list_id in range(len(mat_files)):
        ...
        germany50_ddos1_performance = {'performance_average_train_KMeans': performance_average_train_KMeans,
    ...
    # save variables
    with open('./result/performance_germany50_ddos1.pickle', 'wb') as f:
        pickle.dump([germany50_ddos1_performance], f)

    with open('./result/performance_germany50_ddos1.pickle', 'rb') as f:
